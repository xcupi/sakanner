...
// associated with a database family where identifiable. Independently
// re-derived from internal/detectors/sqli's own already-reviewed
// table (Phase 3.3) rather than imported -- no detector in this
// codebase imports another detector's package, preserving detector
// independence (see docs/phase-3-20-sqli.md section 1 finding 9).
...
// than a phrase distinctive to one real database family.
